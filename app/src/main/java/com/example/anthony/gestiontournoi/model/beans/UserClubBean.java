...
public class UserClubBean {
     ...
     * called by internal mechanisms, do not call yourself.
     */
    @Generated(hash = 61479065)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getUserClubBeanDao() : null;
    }

    /**
     * Used for active entity operations.
     */
    @Generated(hash = 1267696441)
    private transient UserClubBeanDao myDao;
    /**
    ...
    @Generated(hash = 828037775)
    public UserClubBean(long userId, long clubId) {
        this.userId = userId;
        this.clubId = clubId;
    }

    @Generated(hash = 1196344102)
    public UserClubBean() {
    }
}
