...
public class UserTeamBean {
     ...
     * called by internal mechanisms, do not call yourself.
     */
    @Generated(hash = 1583482755)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getUserTeamBeanDao() : null;
    }

    /**
     * Used for active entity operations.
     */
    @Generated(hash = 2102490805)
    private transient UserTeamBeanDao myDao;
    /**
    ...
    @Generated(hash = 2048411845)
    public UserTeamBean(long userId, long teamId) {
        this.userId = userId;
        this.teamId = teamId;
    }

    @Generated(hash = 643902935)
    public UserTeamBean() {
    }
}
