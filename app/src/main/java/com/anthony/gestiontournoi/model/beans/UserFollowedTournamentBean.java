...
@Generated(hash = 1687013874)
private transient UserFollowedTournamentBeanDao myDao;
...
/** called by internal mechanisms, do not call yourself. */
@Generated(hash = 838739189)
public void __setDaoSession(DaoSession daoSession) {
    this.daoSession = daoSession;
    myDao = daoSession != null ? daoSession.getUserFollowedTournamentBeanDao() : null;
}
@Generated(hash = 806927470)
public UserFollowedTournamentBean(long userId, long tournamentId) {
        this.userId = userId;
        this.tournamentId = tournamentId;
}
@Generated(hash = 1725178110)
public UserFollowedTournamentBean() {
}
}
