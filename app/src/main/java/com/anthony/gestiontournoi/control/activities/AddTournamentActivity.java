    ...
    public void onClick(View v) {
        if (v == ibStartDate) {
            ...
            if (!etNbPlayer.getText().toString().isEmpty()) {
                nbPlayer =etNbPlayer.getText().toString();
            }
            ...
            tournamentBean.setGenderNumberOfPlayer(etGender.getText().toString() + "  " + etNbPlayer.getText().toString());
            ...
            try {
                ...
                intentTournament.putExtra(ServiceTournament.SERVICE_TYPE, ServiceTournament.ServiceAction.ADD_TOURNAMENT);
